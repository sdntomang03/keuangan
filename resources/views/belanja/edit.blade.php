            ...
            <form action="{{ route('belanja.update', $belanja->id) }}" method="POST" class="space-y-6">
                ...
                <div
                    ...
                    <div x-data="rekananDropdown({
                            initialId: '{{ old('rekanan_id', $belanja->rekanan_id) }}',
                            initialName: '{{ $belanja->rekanan->nama_rekanan ?? 'Pilih Rekanan...' }}'
                        })" class="relative">
                                                ...
                                                <td class="p-4 w-56">
                                                    <div class="flex items-center gap-2">
                                                        ...
                                                        <button type="button" @click="removeItem(index)"
                                                            ...
                                                            class="flex-shrink-0 p-1.5 text-red-400 bg-red-50 hover:bg-red-500 hover:text-white rounded-lg transition-all duration-200 shadow-sm border border-red-100">
