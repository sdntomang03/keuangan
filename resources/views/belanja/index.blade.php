                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                    ...
                                    <td class="px-4 py-4 text-center">
                                        <div class="flex justify-center items-center space-x-3">
                                            ...
                                            <form action="{{ route('belanja.duplicate', $belanja->id) }}" method="POST"
                                                class="inline-block"
                                                onsubmit="return confirm('Apakah Anda yakin ingin menduplikat transaksi ini?');">
                                                @csrf
                                                <button type="submit" class="text-gray-400 hover:text-blue-600 ml-2"
