...
<head>
    ...
    <title>Cetak Massal Laporan Dokumentasi</title>
    ...
    <style>
        ...
        :root {
            ...
            --bg-body: #f1f5f9;
            --border-color: #cbd5e1;
            var(--font-main): 'Plus Jakarta Sans', sans-serif;
        }
...
<body>
    ...
    {{-- PERULANGAN UNTUK SETIAP SPJ / EKSKUL --}}
    @foreach($spjs as $spj)
    ...
    <div class="page">
        <div class="title-section">
            <h2>DOKUMENTASI EKSTRAKURIKULER {{ $spj->ekskul->nama }}</h2>
        </div>
