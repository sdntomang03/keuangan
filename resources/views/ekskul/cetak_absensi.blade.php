...
<head>
    ...
    <style>
        ...
        /* ==========================
           LAYOUT HALAMAN (PORTRAIT)
           ========================== */
        .page {
            width: 210mm;
            min-height: 297mm;
            /* A4 Standard */
            /* PADDING LAYAR: Atas dikecilkan jadi 5mm */
        ...
        /* ==========================
           LAYOUT HALAMAN (LANDSCAPE - REKAP)
           ========================== */
        .page-landscape {
            width: 297mm;
            /* Lebar A4 Landscape */
        ...
        .rekap-table td {
            ...
            padding: 6px 8px;
            /* Padding sel tabel rekap diperkecil */
        ...
        .photo-container {
            width: 100%;
            height: 480px;
            /* Foto sedikit lebih tinggi karena space atas bertambah */
            background-color: #f1f5f9;
        ...
        @media print {
            ...
            /* 1. ATURAN HALAMAN PORTRAIT (DEFAULT) */
            @page {
                size: A4 portrait;
                margin: 0;
            }

            /* 2. ATURAN KHUSUS HALAMAN LANDSCAPE */
            @page landscape-page {
                size: A4 landscape;
                margin: 0;
            }
            ...
            <table class="info-table">
                <tr>
                    ...
                    <td style="font-weight: bold;">
                        ...
                        // Mengubah angka quarter (1-4) menjadi Romawi
            ...
            <table class="signature-table">
                <tr>
                    ...
                    <td width="33%">
                        ...
                        <div style="height: 10px;"></div>
                        <div class="sign-name">{{ $spj->rekanan->nama_rekanan }}</div>
                        <div class="sign-nip">NPWP. {{ $spj->rekanan->npwp ?? '-' }}</div>
                    </td>
                </tr>
            </table>
        </div>
