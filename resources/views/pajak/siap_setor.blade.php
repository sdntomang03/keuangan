    ...
    <div class="py-12 bg-gray-50" x-data="{ openModal: false, selectedPajak: {}, actionUrl: '' }">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p class="text-sm text-gray-500">Daftar pajak yang telah dipungut dan harus disetorkan ke kas
                        negara.</p>
                </div>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-xs text-gray-500">
                                ...
                                <span class="block text-[10px] text-blue-500 font-bold uppercase">No: {{
                                    $pajak->belanja->no_bukti ?? '-' }}</span>
                            </td>
                        ...
                        @empty
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center text-gray-400 italic">Tidak ada antrean pajak
                                yang perlu disetor.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
        ...
        <div x-show="openModal" class="fixed inset-0 z-50 overflow-y-auto" style="display: none;">
            <div class="flex items-center justify-center min-h-screen px-4">
                <div class="fixed inset-0 bg-gray-900 bg-opacity-50 transition-opacity" @click="openModal = false">
                </div>
                ...
                <div class="relative bg-white rounded-3xl shadow-2xl max-w-md w-full p-8">
                    <div class="mb-6">
                        ...
                        <p class="text-sm text-gray-500">Anda akan menyetorkan <span class="font-bold text-orange-600"
                                x-text="selectedPajak.name"></span> sebesar <span class="font-bold text-orange-600"
                                x-text="'Rp ' + selectedPajak.amount"></span> ke Kas Negara.</p>
                    </div>
                    ...
                    <form :action="actionUrl" method="POST">
                        ...
                        <div class="mt-8 flex gap-3">
                            <button type="button" @click="openModal = false"
                                class="flex-1 px-4 py-3 text-gray-400 text-xs font-black uppercase">Batal</button>
                            <button type="submit"
                                class="flex-1 px-4 py-3 bg-orange-500 text-white text-xs font-black uppercase rounded-xl shadow-lg shadow-orange-200">Kirim
                                ke BKU</button>
                        </div>
                    </form>
                </div>
