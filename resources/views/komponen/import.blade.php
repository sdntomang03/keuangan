            ...
            <div class="col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2 col-sm-12 col-xs-12">
                <div class="white-box border-top-lg border-top-blue">
                    <div class="m-b-20 b-b p-b-10">
                        ...
                        <p class="text-muted">Unggah satu atau beberapa file JSON sekaligus. Sistem akan otomatis
                            mendeteksi
                    ...
                    <form class="form-horizontal form-material" action="{{ route('komponenrkas.storeImport') }}"
                        ...
                        <div class="form-group m-t-20">
                            ...
                            <div class="col-xs-12">
                                <input type="number" name="tahun" class="form-control" value="{{ date('Y') + 1 }}"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="form-group m-t-20">
                            ...
                            <div class="col-xs-12">
                                ...
                                <span class="help-block"><small>Hanya digunakan jika nama file gagal dibaca. Jika nama
                                        file
                        ...
                        <div class="form-group m-t-20">
                            <label class="col-xs-12 font-bold">File JSON Komponen <span
                                    class="text-danger">*</span></label>
                            <div class="col-xs-12">
                                <input type="file" name="json_files[]" class="form-control" accept=".json" multiple
                                    required style="border: 1px solid #e4e7ea; padding: 5px;">
