                ...
                <div class="relative" @click.away="rekeningOpen = false">
                    ...
                    <div class="relative">
                        <input type="text" x-model="rekeningSearch" @focus="rekeningOpen = true"
                            @input="rekeningOpen = true; kode_rekening = ''"
                        ...
                        <!-- Tombol Clear -->
                        <button x-show="rekeningSearch !== ''"
                            @click="rekeningSearch = ''; kode_rekening = ''; cariData();" type="button"
                            class="absolute right-3 top-2.5 text-slate-400 hover:text-rose-500 transition"
                            style="display: none;">
                    ...
                    <div x-show="rekeningOpen" style="display: none;" x-transition
                        ...
                        <div x-show="filteredRekening.length === 0"
                    ...
                    <table class="w-full text-left text-sm whitespace-nowrap">
                        <thead class="bg-slate-50 text-slate-600 border-b border-slate-200 sticky top-0 shadow-sm z-10">
                            <tr>
                                ...
                                <th class="py-3 px-4 font-bold text-xs uppercase tracking-wider">Kategori</th>
