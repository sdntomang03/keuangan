...
<div style="padding-left: 95px; margin-top: 20px;">
    <p style="text-align: justify; text-indent: 48px; line-height: 1.6;">
        ...
        kegiatan {{ $surat->nama_kegiatan }} di {{ $sekolah->nama_sekolah }}, serta Surat Penawaran Kerja Sama dari {{
        $rekanan->nama_rekanan }}. Maka dengan ini
        kami mohon untuk saudara mengirimkan penawaran harga sesuai dengan Komponen Barang / Jasa yang kami perlukan
        sebagai berikut :
    </p>
