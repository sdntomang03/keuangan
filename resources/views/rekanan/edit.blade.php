        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('setting.rekanan.update', $rekanan->id) }}" method="POST">
                        @csrf
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="nama_rekanan" class="block mt-1 w-full" type="text"
                                        name="nama_rekanan" :value="old('nama_rekanan', $rekanan->nama_rekanan)"
                                        required />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="no_telp" class="block mt-1 w-full" type="text" name="no_telp"
                                        :value="old('no_telp', $rekanan->no_telp)" />
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea id="alamat" name="alamat"
                                        ...
                                        rows="2">{{ old('alamat', $rekanan->alamat) }}</textarea>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="nama_pimpinan" class="block mt-1 w-full" type="text"
                                            name="nama_pimpinan"
                                            :value="old('nama_pimpinan', $rekanan->nama_pimpinan)" />
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <select name="pkp"
                                            ...
                                            <option value="Ya" {{ old('pkp', $rekanan->pkp) == 'Ya' ? 'selected' : ''
                                                }}>Ya (PKP)</option>
                                            <option value="Tidak" {{ old('pkp', $rekanan->pkp) == 'Tidak' ? 'selected' :
                                                '' }}>Tidak (Non-PKP)</option>
                                        </select>
                                    </div>
                                </div>
                                <div>
