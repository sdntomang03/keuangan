                                ...
                                <tr
                                    ...
                                    <td class="px-6 py-4" x-data="{ expanded: false }">
                                        <div class="flex flex-col">
                                            ...
                                            $twAktif = (int) filter_var($sekolah->triwulan_aktif,
                        ...
                        <div class="flex items-center justify-center gap-2">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <form action="{{ route('bku.unpost', $item->belanja_id) }}" method="POST"
                                    ...
                                    @csrf
                                    @method('PUT')
                                    <button type="submit" onclick="return confirm('Batalkan posting belanja ini?')"
                                ...
                                @if($item->pajak_id)
                                <form action="{{ route('pajak.hapus_setor', $item->pajak_id) }}" method="POST"
                                    class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
                                        class="p-2 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-full transition-colors"
                                        onclick="return confirm('Hapus bukti setoran?')" title="Hapus Setoran">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <form action="{{ route('bku.destroy', $item->id) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
            ...
            <div class="flex items-center justify-center min-h-screen px-4">
                ...
                <div
                    ...
                    <form action="{{ route('penerimaan.store') }}" method="POST">
                        ...
                        <div class="space-y-4">
                            <div>
                                <label class="block text-[10px] font-black uppercase text-gray-400 mb-1">Tanggal</label>
                            ...
                            <div>
                                <label class="block text-[10px] font-black uppercase text-gray-400 mb-1">Uraian</label>
        ...
        <template x-teleport="body">
            <template x-if="open">
                        ...
                        <div
                            ...
                            <div class="p-6">
                                ...
                                <div x-show="loading" class="py-12 text-center">
                                    ...
                                    <p class="text-xs font-bold text-gray-400 uppercase tracking-widest animate-pulse">
                                        Menarik data...</p>
                                </div>
               ...
               .trim()">
                                                ...
                                                {{-- Info Rekanan & Bank --}}
                                                <div class="bg-white p-3 rounded-lg border border-gray-100 space-y-2">
                                                    <div>
                                                        <label
