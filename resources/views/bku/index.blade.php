        ...
        <div x-show="openModal" x-cloak class="fixed inset-0 z-[70] overflow-y-auto"
            ...
            <div class="flex items-center justify-center min-h-screen px-4">
                ...
                <div
                    ...
                    <h3 class="text-xl font-black text-gray-800 uppercase tracking-tight mb-6">Tambah Penerimaan</h3>
                ...
                <div class="flex items-center justify-center min-h-screen px-4">
                    ...
                    <div
                        ...
                        <div class="flex justify-between items-center mb-6">
                            <h3 class="text-xl font-black text-blue-600 uppercase tracking-tight">Edit Penerimaan</h3>
